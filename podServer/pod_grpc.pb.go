...
const (
	PodService_RegisterUsername_FullMethodName = "/pod.PodService/RegisterUsername"
)
...
func (c *podServiceClient) RegisterUsername(ctx context.Context, in *RegisterUsernameRequest, opts ...grpc.CallOption) (*RegisterUsernameResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegisterUsernameResponse)
	err := c.cc.Invoke(ctx, PodService_RegisterUsername_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPodServiceServer) RegisterUsername(context.Context, *RegisterUsernameRequest) (*RegisterUsernameResponse, error) {
...
func _PodService_RegisterUsername_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterUsernameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PodServiceServer).RegisterUsername(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PodService_RegisterUsername_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PodServiceServer).RegisterUsername(ctx, req.(*RegisterUsernameRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _PodService_RegisterUsername_Handler,
		},
	},
